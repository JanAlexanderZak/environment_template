""" Collection of functions that are frequently used.
"""
...
class SciColorscales:
    """
	This class contains the scientific colormaps converted to Plotly colorscales.
	(see http://www.fabiocrameri.ch/visualisation.php, 
	and https://zenodo.org/record/1243863#.Ww6bgEiFNPY)
	"""
	acton = [
		[0.0, "rgb(46, 33,77)"],
		[0.1, "rgb(72, 56, 100)"],
